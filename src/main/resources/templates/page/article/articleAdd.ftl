	...
	<div class="layui-col-md9 layui-col-xs12">
			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input newsName" lay-verify="newsName" placeholder="请输入文章标题" id="articleTitle" name="articleTitle">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">内容摘要</label>
					<div class="layui-input-block">
						<textarea placeholder="请输入内容摘要" class="layui-textarea abstract" id="articleAbstract" name="articleAbstract"></textarea>
					</div>
				</div>
			</div>
		...
		<div class="layui-form-item magb0">
			...
			<div class="layui-input-block">
				...
				<textarea class="layui-textarea layui-hide" name="articleContent" lay-verify="articleCommentcount" id="articleContent"></textarea>
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="page/article/articleAdd.js"></script>
</body>
</html>